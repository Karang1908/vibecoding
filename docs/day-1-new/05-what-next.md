...
!!! tip "Only rule"
    One sentence to describe it = right size.
...
Tomorrow: a **real app** — remembers things, connects to actual AI, lives on the internet with a link you can send anyone.

Plus the trick we've been saving:

<p class="beat">How to give your intern a memory.</p>

One sentence. Changes everything.

**See you tomorrow. Bring the laptop.**
