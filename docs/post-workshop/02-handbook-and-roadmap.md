...
## Community & Next Steps: GDG BITS Pilani Dubai Campus

The completion of this workshop is the beginning of your journey as an AI-first builder. Here is how to stay engaged:

<div class="gdg-card-grid">

  <div class="gdg-card">
    <span class="gdg-badge gdg-badge-blue">Annual Competition</span>
    <h3 style="margin: 0.5rem 0;">Google Solution Challenge</h3>
    <p style="font-size: 0.9rem;">
      Apply the vibecoding techniques learned in this workshop to build solutions that address one or more of the United Nations 17 Sustainable Development Goals using Google technologies.
    </p>
    <a href="https://developers.google.com/community/gdsc-solution-challenge" target="_blank" rel="noopener" style="color: #4285F4; font-size: 0.85rem; font-weight: 600;">Learn About Solution Challenge &rarr;</a>
  </div>

  <div class="gdg-card">
    <span class="gdg-badge gdg-badge-green">Chapter Membership</span>
    <h3 style="margin: 0.5rem 0;">Join GDG BITS Pilani Dubai Campus</h3>
    <p style="font-size: 0.9rem;">
      Connect with fellow student developers, participate in campus hackathons, technical speaker sessions, and collaborative open-source projects.
    </p>
    <a href="https://developers.google.com/community/gdg" target="_blank" rel="noopener" style="color: #34A853; font-size: 0.85rem; font-weight: 600;">GDG Chapter Portal &rarr;</a>
  </div>
